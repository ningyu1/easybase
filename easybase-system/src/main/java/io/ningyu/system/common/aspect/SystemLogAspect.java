...
import io.ningyu.common.annotation.log.AfterLog;
import io.ningyu.common.annotation.log.AroundLog;
import io.ningyu.common.annotation.log.BeforeLog;
...
public class SystemLogAspect {
     ...
     * Before切点
     */
    @Pointcut("@annotation(io.ningyu.common.annotation.log.BeforeLog)")
     ...
     * After切点
     */
    @Pointcut("@annotation(io.ningyu.common.annotation.log.AfterLog)")
     ...
     * Around切点
     */
    @Pointcut("@annotation(io.ningyu.common.annotation.log.AroundLog)")
