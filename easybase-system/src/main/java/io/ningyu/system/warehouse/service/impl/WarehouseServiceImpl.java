...
public class WarehouseServiceImpl extends ServiceImpl<WarehouseMapper, WarehouseEntity> implements IWarehouseService {
    ...
    @Override
    public Page<WarehouseEntity> selectList(Page<WarehouseEntity> page, WarehouseEntity entity) {
        Page<WarehouseEntity> list = warehouseMapper.selectList(page, entity);
        return list;
    }
}
